...
## Текущая задача
Подготовить файловую структуру и начальные файлы для темы WordPress в соответствии с разделами «Структура темы», «Блоки главной страницы» и «Дизайн-решения (принятые)»
